...
#     model.loc['L', 'disk'] = sersic_ltot(disk.I, disk.Re, disk.q, 1.0, 2.0)
...
#     bulge_l = sersic_ltot(bulge.I, bulge.Re, bulge.q, bulge.n, 2.0)
...
#     bar_l = sersic_ltot(bar.I, bar.Re, bar.q, bar.n, bar.c)
